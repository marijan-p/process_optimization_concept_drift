...
\begin{table}[tbp]
    ...
    \textbf{Modelltyp} & \textbf{Bester \ac{MAE}} & \textbf{$\Delta$ Best} & \textbf{Bester \ac{MAE}} &  \textbf{$\Delta$ Best} \\
        ...
        \ac{MLP} (statisch) & 0,00745 & \textbf{0,0\%} & 0,01140 & +16,2\% \\
        \ac{MLP} (dynamisch) & 0,01017 & +36,5\% & 0.01226 & +25,0\% \\
        \ac{CNN} & 0,00822 & +10,3\% & 0,01278 & +30,3\% \\
...
\begin{figure}[tbp]
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \input{../plots/model_comparison_stationary.pgf}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \input{../plots/model_comparison_transient.pgf}
